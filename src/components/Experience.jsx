const Experience = () => {
    return (
        <div id="Experience" className="scroll-mt-24 flex min-h-screen w-full flex-col items-center justify-center p-15 md:gap-20 md:scroll-mt-0 lg:-36  ">
            <h1 className="bg-gradient-to-r from-teal-400 to-teal-600 bg-clip-text text-6xl font-semibold text-transparent h-18 md:text-7xl md:h-20 lg-text-7xl">Experience</h1>
            <div className="flex flex-wrap gap-0 md:flex-nowrap pt-10 md:pt-0">
                <div>
                    <div className="relative space-y-1 boder-l-2 p-5 text-left md:p-10">
                        ...
                        <ul className="list-disc pl-5 pt-5 md:pl-12 flex flex-col gap-7 text-xl">
